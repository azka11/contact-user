...
describe('POST /api/users/login', () => {
    ...
    it('should be reject to login if username wrong', async () => {
        const response = await supertest(web)
        .post("/api/users/login")
        .send({
            username: "salah",
    ...
    it('should be reject to login if password wrong', async () => {
        const response = await supertest(web)
        .post("/api/users/login")
        .send({
            username: "test",
...
describe('PATCH /api/users/current', () => {
    ...
    it('should be in to update user name', async () => {
        const response = await supertest(web)
        .patch('/api/users/current')
        .set('X-API-TOKEN', 'test')
        .send({
    ...
    it('should be in to update user password', async () => {
        const response = await supertest(web)
        .patch('/api/users/current')
        .set('X-API-TOKEN', 'test')
        .send({
...
describe('DELETE /api/users/current', () => {
    ...
    it('should reject to logout user if token is wrong', async () => {
        const response = await supertest(web)
        .delete('/api/users/current')
        .set('X-API-TOKEN', "salah")
