...
class ContactService {
    static create(user, request) {
        return __awaiter(this, void 0, void 0, function* () {
            const createContactRequest = validation_1.Validation.validate(contact_validation_1.ContactValidation.CREATE, request);
            const record = Object.assign(Object.assign({}, createContactRequest), { username: user.username });
    ...
    static checkContactMustExist(username, contact_id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!contact) {
                throw new response_error_1.ResponseError(404, "Contact has not found");
            }
            return contact;
        });
    }
    static get(user, contact_id) {
        return __awaiter(this, void 0, void 0, function* () {
            const contact = yield this.checkContactMustExist(user.username, contact_id);
            return (0, contact_model_1.toContactResponse)(contact);
        });
    }
    static update(user, request) {
        return __awaiter(this, void 0, void 0, function* () {
            const updateContactRequest = validation_1.Validation.validate(contact_validation_1.ContactValidation.UPDATE, request);
            yield this.checkContactMustExist(user.username, updateContactRequest.contact_id);
    ...
    static remove(user, contact_id) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.checkContactMustExist(user.username, contact_id);
